...
import { Calendar, Check, Star, BookOpen, TrendingUp } from "lucide-react";
    ...
    <div className="bg-gray-50">
      ...
      <section className="relative h-[75vh] min-h-[500px] flex items-center justify-center overflow-hidden shadow-xl">
        <div className="absolute inset-0">
          <img
            src="src/assets/img/thumbnail/WhatsApp2.jpeg"
      ...
      <section className="py-20 container mx-auto px-6 max-w-5xl space-y-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          {[
            { icon: BookOpen, text: "Refuerzo totalmente personalizado" },
            { icon: Star, text: "Mejora real en base matemática" },
            { icon: TrendingUp, text: "Progreso constante y seguimiento" }
          ].map((item, i) => (
            <motion.div
              key={i}
        ...
        >
          <h3 className="text-2xl font-bold text-primary-800 mb-5">
            {t("courseDetail.mathFull.extrasTitle")}
          </h3>

          <ul className="space-y-3">
            {t("courseDetail.mathFull.extras", { returnObjects: true }).map(
              ...
              >
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <h3 className="text-2xl font-semibold text-primary-700">
                    {t(`courseDetail.mathFull.days.${day}.title`)}
                  </h3>
                </div>

                <div className="bg-gray-50 p-5 rounded-2xl shadow-inner border border-gray-200">
                  <ul className="space-y-2">
                    {t(`courseDetail.mathFull.days.${day}.block1`, {
                      returnObjects: true
