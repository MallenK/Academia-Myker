...
const Features: React.FC = () => {
  ...
  const features: Feature[] = [
    {
      title: t('features.items.teachers.title'),
      icon: Award,
      description: t('features.items.teachers.desc')
    },
    {
    ...
    },
    {
      ...
      icon: Clock,
      description: t('features.items.schedule.desc')
    },
    {
      title: t('features.items.method.title'),
      icon: MessageCircle,
      description: t('features.items.method.desc')
    }
  ];
